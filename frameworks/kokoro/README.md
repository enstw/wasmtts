...
現有模型的主要瓶頸在 generator／vocoder 的 dense residual convolution。Selective INT8 只縮小 8.3%，未帶來單線程 WASM 加速；下一個有意義的方向是訓練或蒸餾採 depthwise-separable residual blocks 的 mobile vocoder。雙執行緒在桌面 Chromium 有明顯改善，但仍須真實 iOS Safari 驗證。
