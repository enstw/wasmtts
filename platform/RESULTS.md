...
完整 SQLite run 已掃描 315,593 句與 4,646,998 筆 occurrence；`polyphone` 73,447、`neutral_tone` 118,019、`tone_disagreement` 111,299，三類合計 302,765 筆待審核差異。第一輪完整 ROI 的 11 個固定詞約覆蓋 9,400 筆舊 profile 差異；後兩輪兒化固定詞實際再排除 5,565 筆 `er1` 詞綴語境；多字批次的 `微、血、究、熟、叔、姐姐、差不多` 再排除 22,069 筆，累計約 37,034 筆。`子、頭、差、乾、晃、處、卷、教` 等混合讀音群組標為 `needs_context`，不作全域覆寫；`誰 shui2 → shei2` 已確認但 acoustic tokens 缺少 `shei2`，不啟用未支援 phone。
