...
完整 SQLite run 已掃描 315,593 句與 4,646,998 筆 occurrence；`polyphone` 73,447、`neutral_tone` 118,019、`tone_disagreement` 111,299，三類合計 302,765 筆待審核差異。第一輪完整 ROI 只採教育部詞條明確、可限制為固定詞的 `答應、幾乎、暫時、熟悉、認識、意識、見識、資質、材質、期間、期待`，約覆蓋 9,400 筆舊 profile 差異；不建立對應單字的全域規則。`個、誰、兒` 等高頻項目先保留為地域或模型差異候選，不能因 g2pW 高信心直接覆寫。
